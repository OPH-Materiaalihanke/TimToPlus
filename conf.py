...
project = 'Lukiomateriaalit'
copyright = '2019, Milla Lohikainen'
author = 'Milla Lohikainen'
...
exclude_patterns = ['_build', 'exercises/solutions', '_data', 'Source']
...
#html_show_copyright = '2019, Milla Lohikainen'
